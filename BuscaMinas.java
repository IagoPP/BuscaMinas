...
public class BuscaMinas {
    ...
    /* Recoje el atributo "action" y coordenadas del tablero para decidir que tipo de acción se hará sobre esa casilla */
    ...
    /* pasa al el tablero de usuario desde el de juego todos los núnmeros 0 que toquen a un 0 determinado por unas coordenadas dadas del tablero */
    ...
    /* devuelve el parametro que usa el programa para determinar que una casilla del tablero de usuario está vacía */
    public char getBlank() {
        return blank;
    }
    /* devuelve el parametro asociado a la accion de revelar casillas del tablero de usuario usado por el método "chooseAction" */
    public char getReveal() {
        return reveal;
    }
    /* devuelve el parametro asociado a la accion de poner una bandera en el tablero de usuario usado por el método "chooseAction" */
    public char getFlagin() {
        return flagin;
    }
    /* devuelve el parametro asociado a la accion de poner una interrogación en el tablero de usuario usado por el método "chooseAction" */
    public char getQuestionin() {
        return questionin;
    }
    /* Devuelve el valor del atributo "accion" */
    public char getAction() {
        return action;
    }
    /* Devuelve true si se ha revelado una mina al usar el método "revealAround" */
    ...
    /* Recoge el valor del atributo action que determinara la accion a tomar en el método "chooseAction" */
